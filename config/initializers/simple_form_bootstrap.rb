...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group mb-30', error_class: 'form-group-invalid has_error', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    ...
    b.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback has-error' }
    b.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted help-block' }
  end
